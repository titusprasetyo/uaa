package com.uaa.auth.repository;

import com.uaa.auth.UaaApp;
import com.uaa.auth.config.Constants;
import com.uaa.auth.config.audit.AuditEventConverter;
import com.uaa.auth.domain.PersistentAuditEvent;
...
import static com.uaa.auth.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
